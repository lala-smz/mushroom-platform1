...
CREATE TABLE `carts` (
  ...
  `type` enum('product','box') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'product' ,
...
CREATE TABLE `content_reviews` (
  ...
  `issueTypes` json DEFAULT NULL 淇℃伅閿欒", "涓撲笟鏈涓嶅噯纭?]',
  `suggestedChanges` text COLLATE utf8mb4_unicode_ci ,
  PRIMARY KEY (`id`),
...
CREATE TABLE `cooking_videos` (
  ...
  `mushroomType` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL ,
...
CREATE TABLE `kitchen_post_mushrooms` (
  `id` int NOT NULL AUTO_INCREMENT,
  `postId` int NOT NULL ,
  `mushroomTypeId` int NOT NULL ,
  `quantity` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL ,
  `isMainIngredient` tinyint(1) NOT NULL DEFAULT '0' ,
  PRIMARY KEY (`id`),
...
CREATE TABLE `kitchen_posts` (
  ...
  `leaderboardRank` int DEFAULT NULL ,
...
CREATE TABLE `mushroom_box_items` (
  ...
  `mushroomName` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL ,
  `mushroomType` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL ,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL ,
...
CREATE TABLE `mushroom_boxes` (
  ...
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  `cultivationService` tinyint(1) NOT NULL DEFAULT '0' ,
  `cultivationPrice` decimal(10,2) DEFAULT NULL ,
  `cultivationDuration` int DEFAULT NULL COMMENT '浠ｅ煿鏃堕暱锛堝ぉ锛?,
  `cultivationInclusions` text COLLATE utf8mb4_unicode_ci ,
  `cultivationDescription` text COLLATE utf8mb4_unicode_ci ,
...
CREATE TABLE `mushroom_varieties` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL ,
  `scientificName` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL ,
  ...
  `tasteDescription` text COLLATE utf8mb4_unicode_ci ,
  `cookingMethods` json DEFAULT NULL ,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL ,
  `isActive` tinyint(1) NOT NULL DEFAULT '1' COMMENT '鏄惁涓哄綋鍓嶆椿鍔ㄥ搧绉?,
  `difficulty` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'easy' ,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `mushrooms` (
  ...
  `scientificName` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL ,
  `description` text COLLATE utf8mb4_unicode_ci ,
  `cultivationGuide` text COLLATE utf8mb4_unicode_ci ,
  `season` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL 鏄ュ,绉嬪"',
  `image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL ,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  `growthEnvironment` text COLLATE utf8mb4_unicode_ci ,
  `nutritionalValue` json DEFAULT NULL COMMENT '钀ュ吇浠峰€硷紝鍖呮嫭铔嬬櫧璐ㄣ€佺淮鐢熺礌銆佺熆鐗╄川绛夊惈閲?,
  `safetyInfo` text COLLATE utf8mb4_unicode_ci ,
  `morphology` text COLLATE utf8mb4_unicode_ci ,
  `cookingMethods` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '閫傚疁鐨勭児楗柟娉?,
  `selectionTips` text COLLATE utf8mb4_unicode_ci ,
  `cultivationDifficulty` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '鍩硅偛闅惧害锛坋asy/medium/hard锛?,
  `category` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL ,
  `originInfo` json DEFAULT NULL ,
  `storageMethods` text COLLATE utf8mb4_unicode_ci ,
  `healthBenefits` text COLLATE utf8mb4_unicode_ci ,
  `culturalInfo` text COLLATE utf8mb4_unicode_ci ,
  `marketInfo` json DEFAULT NULL ,
  `dataSource` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL ,
  `dataUpdatedAt` datetime DEFAULT NULL ,
  `status` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active' COMMENT '鐘舵€侊紙active/inactive锛?,
...
CREATE TABLE `operation_logs` (
  ...
  `targetName` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL ,
  `description` text COLLATE utf8mb4_unicode_ci ,
...
CREATE TABLE `orders` (
  `id` int NOT NULL AUTO_INCREMENT ,
  `orderNo` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL ,
  `userId` int NOT NULL ,
  ...
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  `paymentSignature` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL ,
  `paymentTimeout` datetime DEFAULT NULL ,
  `transactionId` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL ,
  `paymentInfo` json DEFAULT NULL ,
  `cancelledReason` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL ,
  PRIMARY KEY (`id`),
...
CREATE TABLE `products` (
  ...
  `rejectType` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL ,
  `rejectRule` text COLLATE utf8mb4_unicode_ci ,
  `rejectedAt` datetime DEFAULT NULL ,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  `isHot` tinyint(1) NOT NULL DEFAULT '0' ,
  `subCategory` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' ,
  `subSubCategory` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL ,
  PRIMARY KEY (`id`),
...
CREATE TABLE `recipe_videos` (
  ...
  `videoType` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'recipe' ,
...
CREATE TABLE `recipes` (
  ...
  `image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL ,
  `status` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active' COMMENT '鐘舵€侊紙active/inactive锛?,
  `nutritionalAnalysis` json DEFAULT NULL ,
  `suitableFor` json DEFAULT NULL ,
  `flavorProfile` json DEFAULT NULL ,
  `cuisineType` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL ,
  `mealType` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL ,
  `mushroomCount` int NOT NULL DEFAULT '0' ,
...
CREATE TABLE `recommended_recipes` (
  ...
  `userId` int NOT NULL ,
  `recipeId` int NOT NULL ,
  `recommendedAt` datetime NOT NULL ,
...
CREATE TABLE `subscriptions` (
  `id` int NOT NULL AUTO_INCREMENT,
  `userId` int NOT NULL ,
  `planType` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL ,
  `deliveryCycle` int NOT NULL ,
  ...
  `mushroomCount` int NOT NULL DEFAULT '3' ,
...
CREATE TABLE `user_box_orders` (
  ...
  `trackingNumber` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL ,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  ...
  `cultivationEndDate` datetime DEFAULT NULL ,
  `cultivationProgress` int DEFAULT NULL COMMENT '浠ｅ煿杩涘害锛堢櫨鍒嗘瘮锛?,
  `cultivationNotes` text COLLATE utf8mb4_unicode_ci ,
  `cultivationUpdates` json DEFAULT NULL ,
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`),
  KEY `boxId` (`boxId`),
...
CREATE TABLE `user_preferences` (
  `id` int NOT NULL AUTO_INCREMENT ,
  `userId` int NOT NULL ,
  `tastePreferences` json DEFAULT NULL spicy": true, "sweet": false}锛?,
  `dietaryRestrictions` json DEFAULT NULL vegetarian", "gluten_free"]锛?,
...
CREATE TABLE `video_recipes` (
  ...
  `relevance` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL ,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `videos` (
  ...
  `copyrightInfo` text COLLATE utf8mb4_unicode_ci ,
